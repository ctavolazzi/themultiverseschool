...
def play():  # Changed to accept optional duration
    try:
    ...
    try:
        ...
        raise  # Re-raise the KeyboardInterrupt to be caught by the main function
...
def create_flask_app():
    ...
    # Create CSS file with enhanced styling
    css_content = '''
:root {
    --neon-purple: #b026ff;
    --dark-purple: #2a0134;
...
def create_second_script():
    """Create the second script that sets up a full project structure"""
    os.makedirs('project_templates', exist_ok=True)
    
    second_script = '''import os
import shutil
from pathlib import Path

def create_project_structure():
    """Create a new Flask project structure"""
    project_dir = 'my_multiverse_app'
    ...
    # Create run.py
    run_py_content = """from flask import Flask

app = Flask(__name__)

@app.route('/')
def index():
    return 'Welcome to your Multiverse Project!'
...
"""
    ...
    # Copy users.json to new project directory
    shutil.copy('../users.json', '.')

    print("\\nProject structure created successfully!")
    print("\\nTo start your application:")
    print("1. cd my_multiverse_app")
    print("2. python -m venv venv")
    print("3. On Windows: .venv\\Scripts\\\\activate")  # Fixed Windows path
    print("   On Unix/Mac: source venv/bin/activate")
    print("4. pip install -r requirements.txt")
    print("5. python run.py")
    print("\\nStart exploring and building your multiverse!\\n")
...
def main():
    ...
    try:
        play()  # Removed duration parameter
    except KeyboardInterrupt:
        # Clear the screen
        os.system('cls' if os.name == 'nt' else 'clear')
        print("\n\n")
